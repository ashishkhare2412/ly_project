...
Point2f Source[] = {Point2f(70,170),Point2f(285,170),Point2f(5,240), Point2f(340,240)};
...
void Threshold()
{
	...
	inRange(frameGray, 180, 255, frameThresh);
...
void Stop_detection()
{
    if(!Stop_Cascade.load("//home//pi//Desktop//MACHINE LEARNING//stop_sign.xml"))
    {
